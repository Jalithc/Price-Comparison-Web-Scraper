...
def compare_prices(product_laughs, product_glomark):
    ...
    price_laughs = float(laughs_soup.find("span", class_="regular-price").text.strip()[3:])
    product_name_laughs = laughs_soup.find("div", class_="product-name").text.strip()
    ...
    product_name_glomark = json.loads(glomark_soup.find("script", type="application/ld+json").text.strip())["name"]
